...
import { EyeIcon, EyeSlashIcon, ArrowRightIcon, UserIcon, AcademicCapIcon } from '@heroicons/react/24/outline';
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12">
          <div className="max-w-md animate-slide-right">            <div className="mb-12">              <h1 className="brand-nexus mb-4">
                ...
                <br />
                <span className="text-orange-500">Nexus</span> <span className="text-gray-800">Learning</span>
                ...
                <div className="space-y-4">
                        ...
                        return (
                          <label key={option.value} className="cursor-pointer">
                            <input
                              ...
                              onChange={handleChange}
                              className="sr-only"
                            />                            <div className={`p-4 rounded-xl transition-all duration-200 flex items-start space-x-3 bg-white border-2 ${
                              formData.role === option.value 
                                ? 'border-orange-500 bg-orange-50' 
                                : 'border-gray-300 hover:border-gray-400'
                            }`}>
                              <IconComponent className="h-5 w-5 text-orange-600 flex-shrink-0 mt-0.5" />
                              <div className="flex-1">
                                <div className="text-body font-medium text-gray-800">{option.label}</div>
                  ...
                  <div>
                    ...
                    <div className="relative">                      <input
                      ...
                      <button
                        type="button"
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-700 hover:text-gray-800 transition-colors duration-200"
