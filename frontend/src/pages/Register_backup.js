...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-gradient-radial opacity-50"></div>
      <div className="absolute bottom-1/3 left-1/4 w-64 h-64 bg-gradient-radial opacity-30"></div>
          ...
          <div className="max-w-md animate-slide-right">
            <div className="mb-12">
              <h1 className="text-display font-sf font-extralight mb-6">
                ...
                <br />
                <span className="text-white">Reactor Minds</span>
              </h1>
            ...
            <div className="space-y-6 text-body text-text-white-muted">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white font-medium mb-2">Advanced Learning Tools</h3>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-1 h-12 bg-gradient-orange rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-white font-medium mb-2">Global Community</h3>
            ...
            <div className="glass-card rounded-2xl p-8 animate-fade-scale">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="full_name" className="block text-micro text-text-white-muted font-medium mb-3 tracking-wider">
                      FULL NAME
                    </label>
                    <input
                      id="full_name"
                  ...
                  <div>
                    <label htmlFor="role" className="block text-micro text-text-white-muted font-medium mb-3 tracking-wider">
                      ACCOUNT TYPE
                    </label>
                          ...
                          <label key={option.value} className="cursor-pointer">
                            ...
                            <div className={`glass-input p-4 rounded-xl transition-all duration-200 flex items-start space-x-3 ${
                              ...
                              <div className="flex-1">
                                ...
                                <div className="text-caption text-text-white-muted mt-1">{option.description}</div>
                              </div>
                            </div>
                          </label>
                        );
                  ...
                  <div>
                    <label htmlFor="confirmPassword" className="block text-micro text-text-white-muted font-medium mb-3 tracking-wider">
                      CONFIRM PASSWORD
                    </label>
                    <div className="relative">
                      <input
