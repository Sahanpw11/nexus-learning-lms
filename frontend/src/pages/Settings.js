              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="btn-primary px-6 py-3 rounded-xl">Save Configuration</button>
                  </div>
                </div>
                ...
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="btn-primary px-6 py-3 rounded-xl">Update Limits</button>
                  </div>
                </div>
              </div>
        ...
        case 'users':
          return (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <button className="btn-primary px-6 py-3 rounded-xl">Save Settings</button>
                  </div>
                </div>
                ...
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                      ...
                      <button className="btn-secondary px-6 py-3 rounded-xl w-full">
                      Manage User Roles
                    </button>
                  </div>
                </div>
              ...
              <div className="glass-card rounded-xl p-6">
                <h4 className="text-lg font-medium text-gray-800 mb-4">Bulk Operations</h4>                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <button className="btn-secondary px-4 py-3 rounded-xl">
                    Export User Data
                  </button>
                  <button className="btn-secondary px-4 py-3 rounded-xl">
                    Import Users (CSV)
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="btn-primary px-6 py-3 rounded-xl">Save Backup Settings</button>
                  </div>
                </div>
                ...
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <button className="btn-primary px-6 py-3 rounded-xl w-full">Create Backup Now</button>                    <button className="btn-secondary px-6 py-3 rounded-xl w-full">
                      Restore from Backup
                    </button>
                    <button className="btn-secondary px-6 py-3 rounded-xl w-full">
      ...
      case 'profile':
        return (
          <div className="space-y-6">
            ...
            <button className="btn-primary px-6 py-3 rounded-xl">Save Changes</button>
          </div>
        );
            ...
            <div className="space-y-6">
              <div className="glass-card p-6 rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <button className="btn-primary px-6 py-3 rounded-xl">Update Password</button>
                </div>
              </div>
              <div className="glass-card p-6 rounded-xl">
                <h4 className="text-gray-800 font-medium mb-4">Two-Factor Authentication</h4>
                <p className="text-gray-600 mb-4">Add an extra layer of security to your account</p>                <button className="btn-secondary px-6 py-3 rounded-xl">
                  Enable 2FA
                </button>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                <div className="space-y-4">                  <button className="btn-secondary px-6 py-3 rounded-xl w-full">
                    Download My Data
                  </button>
                  <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-xl w-full">
                    Delete Account
                  </button>
                </div>
              </div>
